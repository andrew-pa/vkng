...
namespace vkng {
	pipeline::pipeline(device* d, vk::PipelineLayout layout, vk::RenderPass renderpass, 
		uint32_t subpass, options b, vk::Pipeline basepipe, uint32_t baseindex) {

		vk::PipelineViewportStateCreateInfo vp;
		vp.pScissors = &b.scissor; vp.pViewports = &b.viewport;
		vp.viewportCount = vp.scissorCount = 1;
		vk::GraphicsPipelineCreateInfo ifo {
			vk::PipelineCreateFlags(), b.shaders.size(), b.shaders.data(),
			&b.vi, &b.ia, nullptr, &vp, &b.rs, &b.multisample_ifo, nullptr, &b.blend,
