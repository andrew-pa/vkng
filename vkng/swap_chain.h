...
namespace vkng {
	struct swap_chain {
		...
		std::vector<vk::UniqueFramebuffer> create_framebuffers(vk::RenderPass rnp, std::function<void(size_t, std::vector<vk::ImageView>&)> additional_image_views = [](auto, auto) {});
